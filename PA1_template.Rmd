...
The average steps between weekend and weekdays shows relatively similar structures, it seems that the amount of walking may be enhanced over the weekend, however the number of days is also smaller which is prone to being biased. Alternatively it may be possible that people walk less during the week due to their working environment, i.e sitting at a computer. There seems to be a clear margin between average steps in the morning, and this could be among many reasons including, but not limited to hangovers, procrastination, and just pure relaxation.